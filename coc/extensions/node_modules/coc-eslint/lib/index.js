      ...
      workspace: {
        ...
        configuration: async (params, _token, _next) => {
          ...
          for (const item of params.items) {
            ...
            const workspaceFolder = resource.scheme === "untitled" ? import_coc3.workspace.workspaceFolders !== void 0 ? import_coc3.workspace.workspaceFolders[0] : void 0 : import_coc3.workspace.getWorkspaceFolder(resource.fsPath);
            const settings = {
